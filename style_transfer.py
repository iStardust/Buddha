...
class TestOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--style", type=str, default='buddha', help="target style type")
        ...
        self.parser.add_argument("--weight", type=float, nargs=18, default=[1.0]*7+[1.0]*11, help="weight of the extrinsic style")
        self.parser.add_argument("--name", type=str, default='buddha_transfer', help="filename to save the generated images")
        ...
        self.parser.add_argument("--style_file", type=str, default="Tibet-89.jpg")
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        if os.path.exists(os.path.join(args.data_path, args.style, 'images/train', stylename)):
            ...
            tmp = transform2(Image.open(os.path.join(args.data_path, args.style, 'images/train', stylename))).to(device)
            tmp = tmp.reshape(1,3,1024,1024)
            viz += [tmp]
    ...
    save_name = args.name+"_"+args.style_file[:-4]
